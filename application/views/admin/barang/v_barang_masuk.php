            ...
            <div class="card">
              <div class="card-body">
                <div class="table-responsive">
                  <form action="<?php echo base_url().'admin/produk/barang_masuk/addCart'?>" method="post">
                    <table>
                      <tr>
                        <th style="padding-right: 40px;">No. Faktur</th>
                        <th>Tanggal</th>
                        <th></th>
                        <th style="margin-left: 40;">Supplier</th>
                      </tr>
                      <tr>
                        <th><input class="form-control" value="<?php echo $this->session->userdata('faktur'); ?>"
                            type="text" name="faktur" id="faktur" placeholder="No.Faktur" required> </th>
                        <th>
                        ...
                        <td style="margin-left: 100;">
                          <select class="form-control" name="suplier" id="suplier"
                            style="margin-right:10px; width: 250px;" required>
                            <option value="">- No Selected -</option>
                            <?php foreach($sup->result_array() as $i) : 
                            $sess_id=$this->session->userdata('sup');
                            $id_sup = $i['suplier_id'];
                            $nama = $i['suplier_nama'];
                            if($sess_id==$id_sup)
                              echo "<option value='$id_sup' selected>$nama</option>";
                            else
            ...
            <div class="card">
              <div class="card-body">
                <div class="table-responsive">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style="text-align:center; width: 35px"><a
                            href="<?php echo base_url().'admin/produk/barang_masuk/remove/'.$items['rowid'];?>"
                  ...
                  <a href="<?php echo base_url().'admin/produk/barang_masuk/addBarang'?>"
                  ...
                  <table id="zero_config" class="table table-striped table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style="text-align: center;"><b><?php echo $i['jumlah'] ?></b> Jenis</td>
                        <td style="text-align: center;"><b><?php echo $i['total'] ?></b> Barang</td>
                        <td style="text-align: center; width: 80px">
                          <a href="<?php echo base_url().'admin/produk/barang_masuk/detail_masuk'?>?nofak=<?php echo $i['produk_nofak'] ?>" class="btn btn-info btn-sm text-white"><i class="fa fa-bars"></i> Detail</a>
                        </td>
                      </tr>
                      <?php endforeach ?>
                    </tbody>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="<?php echo base_url('admin/produk/kategori/add'); ?>" method="POST" class="form-horizontal">
  ...
  <script type="text/javascript">
    $(document).ready(function () {
      ...
      $("#kode_brg").change(function () {
        ...
        $.ajax({
          type: "POST",
          url: "<?php echo base_url().'admin/produk/barang_masuk/getBarang';?>",
          data: kobar,
