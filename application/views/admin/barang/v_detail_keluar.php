    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <?php 
                $txid = $_GET['trx_id'];
                $x = $this->db->query(" SELECT *, DATE_FORMAT(a.produk_tanggal, '%d-%m-%Y') AS tanggal FROM tb_barang_out a
                INNER JOIN tb_detail_out b ON a.produk_id=b.d_keluar_id WHERE a.produk_id='$txid' Limit 1 ");
                ?>
                            ...
                            <div class="card-body">
                                ...
                                <?php foreach($x->result_array() as $i) : ?>
                                    ...
                                    <tr>
                                        ...
                                        <th> :</th>
                                        <th><b><?php echo $i['produk_kode'] ?></b></th>
                                    </tr>
                                    <?php endforeach ?>
                                </table>
                            </div>
                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center;"><?php echo $i['d_keluar_jumlah'] ?></td>
                                            </tr>
                                            <?php endforeach ?>
                                        </tbody>
                                        <tfoot>
