...
<body>
  ...
  <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
    ...
    <div class="page-wrapper">
                  ...
                  <table id="zero_config" class="table table-striped table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <button type="button" class="btn btn-warning btn-sm text-white" data-bs-toggle="modal" data-bs-target="#update<?php echo $i['satuan_id'] ?>"><i class="fa fa-edit"></i> Edit</button>
                        <button type="button" class="btn btn-danger btn-sm text-white" data-bs-toggle="modal" data-bs-target="#delete<?php echo $i['satuan_id'] ?>"><i class="fa fa-trash"></i> Hapus</button>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="<?php echo base_url('admin/produk/satuan/add'); ?>" method="POST"
      ...
      <div class="modal fade" id="update<?php echo $i['satuan_id']; ?>" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">

            <div class="modal-header">
              <h4 class="modal-title" id="myModalLabel">Update Satuan</h4>
              <button type="button" class="btn-close" data-bs-dismiss="modal"><span aria-hidden="true"></span>
              </button>
            </div>
            <div class="modal-body">
              <form action="<?php echo base_url('admin/produk/satuan/update'); ?>" method="POST"
                class="form-horizontal">
                <div class="form-group ">
                  <label class="control-label">Nama Satuan</label>
                  <input type="hidden" name="id" id="id" value="<?php echo $i['satuan_id'] ?>">
                  <input type="text" name="satuan" id="satuan" class="form-control"
                    value="<?php echo $i['satuan_nama']; ?>" required>
                </div>
            </div>
            <div class="modal-footer">
      ...
      <div id="delete<?php echo $i['satuan_id']  ?>" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <form method="post" action="<?php echo base_url() . 'admin/produk/satuan/delete'; ?>">
              <div class="modal-body">
                <input type="hidden" name="id" value="<?php echo $i['satuan_id']; ?>">
                <p>Yakin ingin menghapus kategori <b><?php echo $i['satuan_nama'] ?></b> ?</p>
              </div>
              <div class="modal-footer">
