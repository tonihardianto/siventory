...
<html lang="en">
  <head>
    ...
    <title>Sistem Inventori | Edit Barang </title>
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="x_panel">
                                ...
                                <?php foreach($edit->result_array() as $i) : 
                                    ...
                                    $barang_stok = $i['barang_min_stok'];
                                    $barang_masuk = $i['barang_input'];
                                    $b_sup_id = $i['barang_suplier_id'];

                                    ?>
                                <div class="x_content">
                                    <form class="" action="<?php echo base_url().'admin/produk/barang/editData' ?>" method="post" novalidate>
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <input type="hidden" name="id" value="<?php echo $barang_id; ?>">
                                                <input class="form-control" data-validate-length-range="6" data-validate-words="2" name="namaBarang" value="<?php echo $barang_nama; ?>" required="required" />
                                            </div>
                                        </div>
                                        <div class="field item form-group">
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" type="number" name="minStok" required="required" value="<?php echo $barang_stok; ?>" /></div>
                                        </div>
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Tanggal Masuk<span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" type="date" name="tanggal" id="tanggal" placeholder="yyyy/mm/dd" value="<?php echo $barang_masuk; ?>" required>
                                            </div>
                                        </div>
                                        <div class="field item form-group">
