...
<body onload="window.print()">
    <div id="laporan">
        ...
        <table border="1" align="center" style="width:900px;margin-bottom:20px;">
            <thead>
                <tr>
                    <th colspan="7" style="text-align:left;">Tanggal : <?php echo $this->session->userdata('awal');?> - <?php echo $this->session->userdata('ahir');?>
                    </th>
                </tr>
                <tr>
        ...
        $no++;
        $nofak=$i['produk_nofak'];
        $tgl=$i['tanggal'];
        $barang_id=$i['d_masuk_barang_id'];
        $barang_nama=$i['barang_nama'];
        $barang_satuan=$i['satuan_nama'];
        $barang_qty=$i['d_masuk_jumlah'];
        ?>
                <tr>
