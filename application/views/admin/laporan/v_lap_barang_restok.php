...
<body onload="window.print()">
    <div id="laporan">
        ...
        <table border="1" align="center" style="width:900px;margin-bottom:20px;">
            ...
            $barang_kategori=$i['kategori_nama'];
            $stok = $i['barang_stok'];
            ?>
                <tr>
                    ...
                    <td style="text-align:left;"><?php echo $barang_kategori ?></td>
                    <td style="text-align:center;"><?php echo $barang_satuan;?></td>
