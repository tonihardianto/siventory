...
<head>
    ...
    <!-- Bootstrap select -->
    <link href="<?php echo base_url().'assets/libs/bootstrap-select/css/bootstrap-select.css'?>" rel="stylesheet">
...
<body>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Informasi Stok Barang Menipis</h4>
                    ...
                    <div class="col-12">
                      ...
                      ?>
                                            <tr>
                                                ...
                                                <td style="text-align: center; width: 100px" class="text-danger"><b>
                                                    <?php echo $i['barang_stok'] ?> <?php echo $i['satuan_nama'] ?></b></td>
                                                <!-- <td style="text-align: center;">
                                                    <button type="button" class="btn btn-warning btn-sm text-white"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#update<?php echo $i['barang_id'] ?>"><i
                                                            class="fa fa-edit"></i> Edit</button>
                                                    <button type="button" class="btn btn-danger btn-sm text-white"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#delete<?php echo $i['barang_id'] ?>"><i
    ...
    <script scr="<?php echo base_url().'assets/libs/bootstrap-select/js/bootstrap-select.min.js'?>"></script>
    <!-- this page js -->
