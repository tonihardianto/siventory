        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center bg-dark">
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    ...
                    <!-- Form -->
                    <form class="form-horizontal mt-3" id="loginform" action="<?php echo base_url().'admin/login/auth' ?>" method="POST">
                        <div class="row pb-4">
                            <div class="col-12">
                ...
                <div id="recoverform">
                    <div class="text-center">
                        <span class="text-white">Silahkan Login menggunakan Username dan Password Anda.</span>
                    </div>
                    <div class="row mt-3">
                        <!-- Form -->
