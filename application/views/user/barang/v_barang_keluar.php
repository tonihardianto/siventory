            ...
            <div class="card">
              <div class="card-body">
                <div class="table-responsive">
                  <form action="<?php echo base_url().'user/barang_keluar/addCart'?>" method="post">
                    <table>
                      <tr>
                        <th>Tanggal</th>
                      </tr>
                    ...
                    <table>
                      ...
                      <tr>
                        <th>
                        <!-- <input type="text" name="kode_brg" id="kode_brg" placeholder="ex: BGID000001" class="form-control input-sm"
                            style="width:180px;"> -->
            ...
            <div class="card">
              <div class="card-body">
                <div class="table-responsive">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style="text-align:center; width: 35px"><a
                            href="<?php echo base_url().'user/barang_keluar/remove/'.$items['rowid'];?>"
                  ...
                  <a href="<?php echo base_url().'user/barang_keluar/addBarang'?>"
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style="text-align: center; width: 80px">
                          <a href="<?php echo base_url().'user/barang_keluar/detail_keluar'?>?trx_id=<?php echo $i['produk_id'] ?>" class="btn btn-info btn-sm text-white"><i class="fa fa-bars"></i> Detail</a>
                        </td>
                      </tr>
                      <?php endforeach ?>
                    </tbody>
  ...
  <script type="text/javascript">
    $(document).ready(function () {
      ...
      $("#kode_brg").change(function () {
        ...
        $.ajax({
          type: "POST",
          url: "<?php echo base_url().'user/barang_keluar/getBarang';?>",
          data: kobar,
