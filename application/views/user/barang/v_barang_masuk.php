            ...
            <div class="card">
              <div class="card-body">
                <div class="table-responsive">
                  <form action="<?php echo base_url().'user/barang_masuk/addCart'?>" method="post">
                    <table>
                      <tr>
                    ...
                    <table>
                      ...
                      <tr>
                        <th>
                        <!-- <input type="text" name="kode_brg" id="kode_brg" value="<?php echo $i['barang_id'] ?>" placeholder="ex: BGID000001" class="form-control input-sm"
                            style="width:180px;"> -->
            ...
            <div class="card">
              <div class="card-body">
                <div class="table-responsive">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style="text-align:center; width: 35px"><a
                            href="<?php echo base_url().'user/barang_masuk/remove/'.$items['rowid'];?>"
                  ...
                  <a href="<?php echo base_url().'user/barang_masuk/addBarang'?>"
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style="text-align: center; width: 80px">
                          <a href="<?php echo base_url().'user/barang_masuk/detail_masuk'?>?nofak=<?php echo $i['produk_nofak'] ?>" class="btn btn-info btn-sm text-white"><i class="fa fa-bars"></i> Detail</a>
                        </td>
                      </tr>
                      <?php endforeach ?>
                    </tbody>
  ...
  <script type="text/javascript">
    $(document).ready(function () {
      ...
      $("#kode_brg").change(function () {
        ...
        $.ajax({
          type: "POST",
          url: "<?php echo base_url().'user/barang_masuk/getBarang';?>",
          data: kobar,
